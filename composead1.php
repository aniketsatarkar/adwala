<?php
	...
	if(isset($_GET['adtype_id']))
		$_SESSION['adtype_id'] = $_GET['adtype_id'];
	else	
		die();
?>
...
<head>
	...
	<script type="text/javascript">
		...
		function getRate()
		{
			var paperId = $('#paper_selection').val();
			var editionId = $('#edition_selection').val();
...
<main>	
	<div class="container">
		...
		<!-- SHOW NEWSPAPER AND EDITION SELECTION BOXES -->
		<div class="row" style="padding: 20px">
			<div class="input-field col s5 left">
				<select id="paper_selection" onchange="paperSelection()">
					<?php getNewspaperSelect(); ?>
					<label>Select Newspaper</label>
				</select>
			</div>
			<div class="input-field col s5 right ">
				<select id='edition_selection' onchange='editionSelection()'>
				</select>
